...
type GameContext = {
    store: Store,
    stage: { tween: Tween, container: Container },
...
const Game: Component<{ propIndex: number, children: GameUIElement }> =
    ({ propIndex, children }) => {
        ...
        const variable: Reactive<Dictionary<string>> = useReactive({}) as Reactive<Dictionary<string>>
