...
export type Variables = Record<string, any> & { reactive: Reactive<Record<string, any>> }

export type GameUIElement = Function2<HTMLCanvasElement, Variables, JSX.Element>

export const Core: Component<{ startAt: number, children: GameUIElement }> =
    ({ startAt, children }) => {
        ...
        const canvans = <canvas id="canvas" width="1280" height="720" onclick={emitClickEvent} /> as HTMLCanvasElement
