  ...
  return (
    <div class={styles.MenuPanel_main}>
      <Button
        ...
        style={{ color: router.active() === 'Save' ? `rgba(74, 34, 93, 0.9)` : `rgba(123,144,169,1)` }}
      >
      ...
      <Button
        ...
        style={{ color: router.active() === 'Load' ? `rgba(11, 52, 110, 0.9)` : `rgba(123,144,169,1)` }}
      >
        <div class={styles.MenuPanel_button_icon}>
      ...
      <Button
        ...
        style={{ 'margin-left': 'auto', color: router.active() === 'Config' ? `rgba(81, 110, 65, 0.9)` : `rgba(123,144,169,1)` }}
      >
        <div class={styles.MenuPanel_button_icon}>
