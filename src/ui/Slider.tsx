...
const Slider: Component<{ track: JSX.Element; thumb: JSX.Element; signal: Reactive<number> }> = (props) => {
    ...
    onMount(() => {
        ...
        thumb.onmousedown = thumb.ontouchstart = (event: MouseEvent | TouchEvent) => {
            ...
            const startX = event instanceof MouseEvent ? event.clientX : event.changedTouches[0].clientX
