...
const 扁平化命令 = {
    对话: Alias(FlattenCommands.say_apply, { text: '文本', name: '名称', clip: '语音' } as const),
    设置背景: Alias(FlattenCommands.image_bg, Object.assign(通用命令参数别名, 图像命令参数别名)),
    设置立绘: Alias(FlattenCommands.image_sprite, Object.assign(通用命令参数别名, 图像命令参数别名)),
    ...
    清空立绘: FlattenCommands.image_clean,
