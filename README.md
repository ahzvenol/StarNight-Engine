...
基于Web技术的视觉小说引擎，[在线体验](https://cusky.tk/webgal/hoshizora/) | [阅读文档](https://edoc.cusky.tk/) | [开发日志](https://edoc.cusky.tk/info/log.html)。

## 优势特点

#### 功能强大

真正移植重制了现有的 Gal 作品，还原原作演出效果，并将随着后续移植重制项目持续更新。

#### 先进稳定

星夜自 2021 年建立项目，目前已经基本实现了开发速度快、扩展性好、表现稳定的开发目标。
