...
GameStartEvent.subscribe(() => FastButtonClickEvent.subscribe(() => console.info('点击快进模式按钮')))
GameStartEvent.subscribe(() => AutoButtonClickEvent.subscribe(() => console.info('点击自动模式按钮')))
