...
export const TextBox: Component<{ text: HTMLElement, name: string }> = (props) => {
    ...
    return (
        <div class={styles.Game_TextBox_container} style={{ 'font-family': config.textboxfont() }}>
            ...
            <div class={styles.Game_TextBox_text} style={{ 'font-size': config.textboxfontsize() }}>{props.text}</div>
