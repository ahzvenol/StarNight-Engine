...
export const TextBox: Component<{ text: Accessor<HTMLElement>, name: Accessor<string> }> = ({ text, name }) => {
    ...
    return (
        <div class={styles.Game_TextBox_container} style={{ 'font-family': config.textboxfont() }}>
            ...
            <div class={styles.Game_TextBox_text} style={{ 'font-size': config.textboxfontsize() }}>{text()}</div>
            <Show when={name() !== ''}>
